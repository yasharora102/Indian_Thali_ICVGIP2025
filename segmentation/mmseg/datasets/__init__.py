...
from .your_dataset_big import YourDataset_BIG
from .your_dataset_big_2 import YourDataset_BIG_2
...
__all__ = [
    ...
    'NYUDataset', 'HSIDrive20Dataset', 'YourDataset',
    'YourDataset_BIG','YourDataset_BIG_2'
]
